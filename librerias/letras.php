...
//global $variable; 
function numtoletras($xcifra,$variable) // $moneda=peso,dolar
{ 
				...
				case 2:
					if ($xcifra < 1 )
						...
						$xcadena = "CERO PESOS $xdecimales/100 M.N.";
                                                ...
                                                $xcadena = "CERO DOLARES $xdecimales/100 USD ";    
						}
					if ($xcifra >= 1 && $xcifra < 2)
						...
						$xcadena = "UN PESO $xdecimales/100 M.N. ";
                                                ...
                                                $xcadena = "UN DOLAR $xdecimales/100 USD ";    
						}
					if ($xcifra >= 2)
						{
                                                if ($variable==1)
						$xcadena.= " PESOS $xdecimales/100 M.N. "; // 
                                                ...
                                                $xcadena.= " DOLARES $xdecimales/100 USD. "; //     
						}
					break;
				} // endswitch ($xz)
			} // ENDIF (trim($xaux) != "")
