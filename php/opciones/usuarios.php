<?php 
	...
	$opcion=$_REQUEST['opcion']; 
 	...
 	switch ($opcion) {
		...
		break;
		case 72:
			echo (json_encode($usuario->insertarcatequipos($_REQUEST['sucursal_id'],$_REQUEST['tipo_equipo'],$_REQUEST['num_equipo'],$_REQUEST['descripcion'],$_REQUEST['marca'],$_REQUEST['modelo'],$_REQUEST['serie'],$_REQUEST['fecha_compra'],$_REQUEST['valor_factura'])));
		break;
		case 73:
